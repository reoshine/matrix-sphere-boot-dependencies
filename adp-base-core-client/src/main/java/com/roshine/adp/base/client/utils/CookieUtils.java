...
public final class CookieUtils {
    ...
    private static void doSetCookie(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            addCookie(request, response, cookieName, cookieValue, cookieMaxAge);
        } catch (Exception e) {
            log.error("设置cookie值失败");
        }
    }
    ...
    private static void addCookie(HttpServletRequest request, HttpServletResponse response, String cookieName, String cookieValue, int cookieMaxAge) {
